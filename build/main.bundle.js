  ...
  const convertImgDataToPng = function () {
    ...
    function deflateSync(literals) {
      ...
      try {
        ...
        const output = (__webpack_require__(6).deflateSync)(input, {
          level: 9
        });
...
// This entry need to be wrapped in an IIFE because it need to be isolated against other modules in the chunk.
(() => {
const Toastify = __webpack_require__(1);
const isMobile = __webpack_require__(2);
const pdfjsLib = __webpack_require__(3);
